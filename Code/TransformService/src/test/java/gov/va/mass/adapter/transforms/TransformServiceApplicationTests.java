...
public class TransformServiceApplicationTests {
	...
	public void testDLUMessage4() throws HL7Exception, MicroserviceException {
		String pipeMsg = "MSH|^~\\&|DG-REG-OUT|500^HL7.VEHU.DOMAIN.GOV:5026^DNS|MASS|^dhcp.epic.com:5106^DNS|20171010163409-0500||ADT^A08^|500 9406|T^|2.5|||AL|NE\r"
		...
		String expected = "MSH|^~\\&|DG-REG-OUT|500^HL7.VEHU.DOMAIN.GOV:5026^DNS|MASS|^dhcp.epic.com:5106^DNS|20171010163409-0500||ADT^A31|500 9406|T|2.5|||AL|NE\r"
				+ "PID|1||3^^^USVHA^IEN~10108^^^USVHA^NI||DXL^PA||19350409|M|P8~DXL^TEST||123 Conf Street^Addr Line 2^Knoxville^TN^37865^^C^^^^^^20171103^20171104||(222)555-8235^^P^DXLTEST@email.com|(222)555-7720|||||666000008\r"
	...
	@Test
	// Patient Update Messages (ADT^A28)
	// should transform exactly same as A08s, except message type stays A28, i.e. does not get changed to A31
	public void testDLUMessage5() throws HL7Exception, MicroserviceException {
		String pipeMsg = "MSH|^~\\&|DG-REG-OUT|500^HL7.VEHU.DOMAIN.GOV:5026^DNS|MASS|^dhcp.epic.com:5106^DNS|20171010163409-0500||ADT^A28^|500 9406|T^|2.5|||AL|NE\r"
				+ "PID|1||3^^^USVHA^IEN~10108^^^USVHA^NI||DXL^PA^^^^||19350409|M|P8^^^^^~DXL^TEST^^^^||123 Conf Street^Addr Line 2^Knoxville^TN^37865^^C^^^^^^20171103^20171104||(222)555-8235^^P^DXLTEST@email.com|(222)555-7720|||||666000008|||||||||\r"
				+ "PV1|1|||||||||||||||||SC VETERAN\r"
				+ "ZCT|1|DXL^EMERGENCY|Brother|123 Emergency St^Apt 111^Madison^WI^^^^|(865)776-0002\r"
				+ "ZEL|1|SC LESS THAN 50%||||||||VERIFIED|||||||||||||||||||||||||||YES|20090917\r"
		...
		String expected = "MSH|^~\\&|DG-REG-OUT|500^HL7.VEHU.DOMAIN.GOV:5026^DNS|MASS|^dhcp.epic.com:5106^DNS|20171010163409-0500||ADT^A28|500 9406|T|2.5|||AL|NE\r"
				+ "PID|1||3^^^USVHA^IEN~10108^^^USVHA^NI||DXL^PA||19350409|M|P8~DXL^TEST||123 Conf Street^Addr Line 2^Knoxville^TN^37865^^C^^^^^^20171103^20171104||(222)555-8235^^P^DXLTEST@email.com|(222)555-7720|||||666000008\r"
				+ "NK1|1||123 Emergency St Apt 111 Madison WI\r"
				+ "PV1|1|||||||||||||||||SC VETERAN\r"
				+ "ZFY|SERVICE CONNECTED|ACTIVE|SERVICE CONNECTED|50% Service Connected\r"
	...
	@Test
	// Patient Update Messages (ADT^A40)
	// A40 should not be touched.
	public void testDLUMessage6() throws HL7Exception, MicroserviceException {
		String pipeMsg = "MSH|^~\\&|DG-REG-OUT|050^HL7.PLATINUM.VISTA.MED.VA.GOV:5026^DNS|MASS|^dhcp.epic.com:5106^DNS|20171129141248-0700||ADT^A40^|050 12751|T^|2.4|||AL|NE|\r"
				+ "PID|1||116^^^USVHA^IEN~500000037^^^USVHA^NI||ADTEDI^MERGETWO^A^^^||19760209|F|ADTEDI^MERGEONE^^^^||499 N James Rd^^Columbus^OH^43219^^P^||(614)257-5200^P^^testing@epic.com|(614)257-5379|||||223447970||||||||||20171128\r"
				+ "PV1|1|||||||||||||||||SC VETERAN\r"
				+ "MRG|115^^^USVHA^IEN\r";
		
		String expected = "MSH|^~\\&|DG-REG-OUT|050^HL7.PLATINUM.VISTA.MED.VA.GOV:5026^DNS|MASS|^dhcp.epic.com:5106^DNS|20171129141248-0700||ADT^A40|050 12751|T|2.4|||AL|NE\r"
				+ "PID|1||116^^^USVHA^IEN~500000037^^^USVHA^NI||ADTEDI^MERGETWO^A||19760209|F|ADTEDI^MERGEONE||499 N James Rd^^Columbus^OH^43219^^P||(614)257-5200^P^^testing@epic.com|(614)257-5379|||||223447970||||||||||20171128\r"
				+ "MRG|115^^^USVHA^IEN\r"
				+ "PV1|1|||||||||||||||||SC VETERAN\r";
