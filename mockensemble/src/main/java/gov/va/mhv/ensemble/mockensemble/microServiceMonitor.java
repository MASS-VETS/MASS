...
public class microServiceMonitor {
    ...
    public void incrementServiceIn() {
        ...
        counter++;
        /* Temp Code */
        if( counter == 1) firstTxTime = System.currentTimeMillis();

        if(counter == 1000) {lastTxTime = System.currentTimeMillis();
        System.out.println("Total Time " + (lastTxTime-firstTxTime));}
        /* Temp Code */
    }
